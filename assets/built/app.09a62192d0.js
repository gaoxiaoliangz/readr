	...
	var Dropdown = function (_Component) {
	    ...
	    _createClass(Dropdown, [{
	        ...
	        value: function hideExpended(e) {
	            ...
	            // console.log(isDescendant(this.dropdown, e.target))
	            // console.log('parent', this.dropdown);
	            // console.log('child', e.target);
	            console.log(e);
	            if (!(0, _isDescendant2.default)(this.dropdown, e.currentTarget)) {
	                // console.log($(this.dropdown).find(e.target).length );
