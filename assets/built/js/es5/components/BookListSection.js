...
var BookListSection = function (_Component) {
    ...
    _createClass(BookListSection, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement("div", { className: "book-list-section" }, _react2.default.createElement("h2", { className: "section-title" }, title), moreLink ? _react2.default.createElement(_reactRouter.Link, { className: "more", to: moreLink }, "查看更多") : null, _react2.default.createElement(_BookList2.default, { bookList: bookList }));
        }
    }]);
