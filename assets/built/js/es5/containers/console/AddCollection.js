...
var AddCollection = function (_Component) {
    ...
    _createClass(AddCollection, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement("form", null, _react2.default.createElement(_Notification2.default, { notification: notification }), _react2.default.createElement("h1", { className: "page-title" }, "Add Collection"), _react2.default.createElement(_Input2.default, { value: this.state.collectionName, onChange: function onChange(e) {
                    return _this4.setState({ collectionName: e.target.value });
                }, placeholder: "Name" }), _react2.default.createElement(_SelectizeInput2.default, { ref: "collectedBooks", onChange: this.searchBooks.bind(this), onValuesChange: function onValuesChange(targetIndex, type) {
                    switch (type) {
                        case 'ADD':
                            _this4.setState({
                                collectedBooks: [].concat(_toConsumableArray(_this4.state.collectedBooks), [_this4.state.bookResults[targetIndex]])
                            });
                            break;
                        case 'REMOVE':
                            _this4.setState({
                                collectedBooks: _this4.state.collectedBooks.filter(function (value, index) {
                    ...
                    return book.title;
                }), placeholder: "Books" }), _react2.default.createElement("textarea", { value: this.state.collectionDesc, onChange: function onChange(e) {
                    return _this4.setState({ collectionDesc: e.target.value });
                }, placeholder: "Description" }), _react2.default.createElement(_Button2.default, { onClick: this.addCollection.bind(this) }, "Add"));
        }
    }]);
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, { searchBooks: _index.searchBooks, handleNotification: _index.handleNotification })(AddCollection);