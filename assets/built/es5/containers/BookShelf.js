...
var BookShelf = function (_Component) {
    ...
    _createClass(BookShelf, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement("div", null, _react2.default.createElement(_BookListSection2.default, { bookList: bookList, title: "我的书架" }));
        }
    }], [{
        key: 'fetchData',
        value: function fetchData(_ref) {
            ...
            return store.dispatch((0, _index.fetchBooks)('user'));
        }
    }]);
