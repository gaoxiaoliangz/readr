...
const styles = __webpack_require__(414);
let CollectionDetail = class CollectionDetail extends _react.Component {
    constructor(props) {
        super(props);
    }
    componentDidMount() {
    ...
    render() {
        ...
        return _react2.default.createElement("div", { className: "collection" }, _react2.default.createElement("div", { styleName: "header" }, _react2.default.createElement(_layout.Container, null, _react2.default.createElement("div", { styleName: "title" }, bookCollection.name), _react2.default.createElement("div", { className: "sub-title" }, "10 \u672C\u4E66"), _react2.default.createElement("div", { className: "book-slider" }, _react2.default.createElement(_BookListSection2.default, { bookEntities: items })), _react2.default.createElement(_form.Button, { onClick: () => {
