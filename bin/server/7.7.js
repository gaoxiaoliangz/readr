	...
	var Signin = function (_Component) {
	    ...
	    _createClass(Signin, [{
	        ...
	        value: function handleSignin(event) {
	            ...
	            (0, _callApi2.default)(_config2.default.LOCAL + 'auth', { method: 'POST', data: params }).then(function (res) {
