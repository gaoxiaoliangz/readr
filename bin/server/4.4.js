	...
	var BookDetail = function (_Component) {
	    ...
	    _createClass(BookDetail, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement("article", { className: "content-container" }, _react2.default.createElement(_Body2.default, { className: "book-info" }), _lodash2.default.isEmpty(bookInfo) && _react2.default.createElement(_Loading2.default, null), _react2.default.createElement("header", { styleName: "book-info-header" }, _react2.default.createElement("div", { className: "left-col" }, bookInfo.cover && _react2.default.createElement("div", { styleName: "book-cover" }, _react2.default.createElement("img", { styleName: "img", src: bookInfo.cover }))), _react2.default.createElement("div", { className: "right-col" }, _react2.default.createElement("h1", { styleName: "book-name" }, bookInfo.title), _react2.default.createElement("div", { styleName: "book-author" }, _react2.default.createElement("strong", null, "作者：", bookInfo.authors && bookInfo.authors.map(function (a) {
	                return a.name;
	            }).join(', '))), bookInfo.title && _react2.default.createElement("div", null, _react2.default.createElement(_form.Button, { to: "/viewer/book/" + bookInfo.id, color: "blue" }, "阅读")))), bookInfo.description && _react2.default.createElement("div", null, _react2.default.createElement("h2", { styleName: "desc" }, "内容简介"), _react2.default.createElement("p", null, bookInfo.description)));
	        }
	    }], [{
	        key: "fetchData",
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".book-info-header_YZOEn {\n  overflow: hidden;\n  margin-top: 40px;\n}\n\n.left-col_3jSrt {\n  float: left;\n  margin-right: 30px;\n}\n\n.book-name_3sk8B {\n  font-size: 1.8rem;\n  font-weight: bold;\n  margin: 15px 0 5px 0;\n  color: var(--text-dark);\n  line-height: 1.2\n}\n.book-author_biVMU {\n  font-size: 1.2rem;\n  margin-bottom: 10px;\n}\n\n.book-cover_16-Yi {\n  margin: 0;\n  width: 134px;\n  height: 184px;\n  top: 0;\n  background: url(" + __webpack_require__(462) + ") no-repeat top;\n  transition: all 0.2s ease 0s;\n  position: relative;\n}\n\n.img_fDYPv {\n  width: 100px;\n  height: 150px;\n  display: block;\n  position: absolute;\n  border: none;\n  left: 17px;\n  top: 7px;\n  border-radius: 4px;\n}\n\n.desc_3L6Gh {\n  font-size: 1.2rem;\n  font-weight: bold;\n  color: var(--text-dark);\n  padding-top: 20px;\n  border-top: 1px solid var(--gray);\n}\n\n", ""]);
	
	// exports
	exports.locals = {
		"book-info-header": "book-info-header_YZOEn",
		"left-col": "left-col_3jSrt",
		"book-name": "book-name_3sk8B",
		"book-author": "book-author_biVMU",
		"book-cover": "book-cover_16-Yi",
		"img": "img_fDYPv",
		"desc": "desc_3L6Gh"
	};
