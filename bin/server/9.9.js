	...
	var Shelf = function (_Component) {
	    ...
	    _createClass(Shelf, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(_Container2.default, null, _react2.default.createElement(_BookListSection2.default, { bookEntities: bookList, title: "我的书架" }));
	        }
	    }], [{
	        key: 'fetchData',
