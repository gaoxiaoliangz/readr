...
import createXstateMiddleware from './xstateMiddleware'
import galleryMachine from './containers/Gallery/machine'

// const rootEpic = combineEpics(shelfEpic)
const epicMiddleware = createEpicMiddleware(rootEpic)
const xstateMiddleware = createXstateMiddleware({
  gallery: galleryMachine
})

// const models = [appModel, shelfModel, bookModel]
const sagaMiddleware = createSagaMiddleware()
const middlewares = [thunk, xstateMiddleware, sagaMiddleware, epicMiddleware]
const enhancers = [
