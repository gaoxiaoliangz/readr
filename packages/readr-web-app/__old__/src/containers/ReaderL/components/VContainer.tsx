...
class VContainer extends Component<Props & OtherProps, void> {
  ...
  addEventListeners() {
    window.addEventListener('scroll', this._handleScroll as any)
    window.addEventListener('scroll', this.handleFastScroll)
    window.addEventListener('resize', this._handleResize as any)
  }

  removeEventListeners() {
    window.removeEventListener('scroll', this._handleScroll as any)
    window.removeEventListener('scroll', this.handleFastScroll)
    window.removeEventListener('resize', this._handleResize as any)
  }
